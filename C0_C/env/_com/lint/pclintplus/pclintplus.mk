...
####################################################################################################
#   Common Rules
#   -e14    Symbol 'Symbol' previously defined (Location)                - ok - Trick mehr Datein mit LINT überprüfen -- not available
#   -e85    Array 'Symbol' has dimension 0                               - ok - Problem im stdio.h
#   -e537   Repeated include file                                        - ok - Doppeltes include
#   -e766   h-File not used in C-File                                    - ok - nicht benutztes include -- not available
...
LINT_RULE = -frz -max_threads=1 -unit_check -dLINT_SWITCH_IGNORE -e14 -e85 -e537 -e766 -e734 -e525 -e534 -e583 -e818 -e716 -e545 -e641 -e765 -e750 -e715 -e845 -e714 -e522 -e774 -e788 -e793 -e1784 \
