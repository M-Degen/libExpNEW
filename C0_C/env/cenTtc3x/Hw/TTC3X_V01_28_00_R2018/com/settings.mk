...
#
###############################################################################
ifeq ($(COMPILER_TOOL_SETTING),HYDAC)
	### special HYDAC-tools - commands ###
	include env/general_setting.mk
	TSK_VIPER_PATH = $(TSK_3X_PATH)
	PERL           = $(PERL_PATH)\bin\perl
else
	### special TTC-tools - commands ###
	TSK_VIPER_PATH  =C:\Program FILES\TASKING\C166-VX C166-VX v3.0r3
	PERL	 		=C:\Perl\bin\perl
	RM				=C:\Program FILES\MinGW\bin\rm
	COPY 			=C:\Program FILES\MinGW\bin\cp
endif
...
TSK_VIPER_COMP_FLAGS += -OabcefgiklopRsY,+predict
TSK_VIPER_COMP_FLAGS += -Wc-w549 -Wc-w589
